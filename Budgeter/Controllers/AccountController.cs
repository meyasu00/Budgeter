       ...
       private ApplicationDbContext db = new ApplicationDbContext();
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    ViewBag.Message = "Check your email to confirm your account. You must confirm your address before you are able to log in.";
        ...
        public async Task<ActionResult> ResendEmailConfirmation(ForgotPasswordViewModel model)
        {
            ...
            if (user != null)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, "Confirm your account", "Thank you for registering with Budget' er! Please confirm your account by clicking <a href=\"" + callbackUrl + "\">here</a>.");
            }
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, "Reset Password", "Budget' er has been notified that you need a new password. Please click <a href=\"" + callbackUrl + "\">here</a> to reset your password.");
        ...
        private async Task<string> SendEmailConfirmationTokenAsync(string userID, string subject)
        {
            ...
            await UserManager.SendEmailAsync(userID, subject, "Please confirm your account with Budget' er by clicking <a href=\"" + callbackUrl + "\">here</a>");
